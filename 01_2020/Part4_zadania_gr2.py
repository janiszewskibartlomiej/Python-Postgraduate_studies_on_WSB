...
plt.plot( 'Year', 'Int_rate', data=eco1, marker='x', color='red', linewidth=2)
...
p.line(eco1['Year'], eco1['HPI'], color = 'red', line_width=2)
show(p)


# version 2 - trzeba zmienic na slownik aby dzialalo

p1.vline_stack([eco1['Int_rate'],
                eco1['HPI']], x = eco1['Year'].astype(str))
...
p.line(eco1['Year'].astype(str), eco1['Int_rate'], line_width=2, legend = 'x')
p.line(eco1['Year'], eco1['HPI'], color = 'red', line_width=2, legend = 'y')
